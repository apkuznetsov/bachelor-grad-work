...
[assembly: SuppressMessage("Globalization", "CA1305:Укажите IFormatProvider", Justification = "<Ожидание>", Scope = "member", Target = "~M:Webapp.Controllers.TestsController.Download(Webapp.Models.Tests.TestDownloadViewModel)~System.Threading.Tasks.Task{Microsoft.AspNetCore.Mvc.IActionResult}")]
[assembly: SuppressMessage("Design", "CA1062:Проверить аргументы или открытые методы", Justification = "<Ожидание>", Scope = "member", Target = "~M:Webapp.Controllers.TestsController.Download(Webapp.Models.Tests.TestDownloadViewModel)~System.Threading.Tasks.Task{Microsoft.AspNetCore.Mvc.IActionResult}")]
